  ...
  const GAMECFG = {
    ...
    MELEE: {
      ...
      swings: [
        ...
        { dur: 0.56, lock: 0.40, shake: 1.5, finisher: true,
          windup: { rot: [1.10, 0.05, 0.12], pos: [0.0, 0.24, 0.14] },

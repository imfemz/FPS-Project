...
(function (root) {
  const GAMECFG = {
    ...
    LAND_SHAKE: { ENABLED: true, amount: 0.06, freq: 5, decay: 11, duration: 0.38 },
    ...
    SFX_FILES: {
      ...
      shield_full: '/audio/shield_full.mp3',        // ramassage orbe bleue (bouclier plein)
    ...
    SFX_GAINS: {
      ...
      bot_hit1: 1.0, bot_hit2: 1.0, bot_hit3: 1.0, bot2_death: 1.0, shield_full: 1.0,
    ...
    AUDIO_IR: {
      ...
      FOOTSTEP_WET: 0.13,  // pas : très subtil
    ...
    STRUCTURE_MODELS: {
      ...
      byType: {
        ...
        metal:     '/models/crate.glb',   // plateformes/piliers 'metal' : modèle crate texturé (cube.glb=placeholder blanc ; concrete_wall=23Mo trop lourd -> 503)
